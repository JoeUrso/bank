        ...
        <nav className="navbar flex w-full items-center justify-between py-6">
            ...
            <ul className="hidden flex-1 list-none items-center justify-end sm:flex">
                {navLinks.map((nav, index) => (
                    <li
                        key={nav.id}
                        // this sets a margin-right on the last li element in the list
            ...
            <div className="flex flex-1 items-center justify-end sm:hidden">
                <img
                    ...
                    // use the "prev" arrow function for toggle, as it will always set the opposite state ie true to false and vice versa
                ...
                >
                    <ul className="flex-1 list-none flex-col items-center justify-end">
                        {navLinks.map((nav, index) => (
                            <li
                                key={nav.id}
                                // this sets a margin-bottom on the last li element in the list
                                className={`cursor-pointer font-poppins text-[16px] font-normal ${
